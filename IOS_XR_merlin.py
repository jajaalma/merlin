...
template_dir = 'templates/cisco/ios_xr'
...
if os.path.exists("Camelot/Cisco/IOS_XR/The_Grail/Grail_DB.json"):
    os.remove("Camelot/Cisco/IOS_XR/The_Grail/Grail_DB.json") 

db = TinyDB('Camelot/Cisco/IOS_XR/The_Grail/Grail_DB.json')
...
class Collect_Information(aetest.Testcase):
    ...
    def parse(self, testbed, section, steps):
        ...
        for device in testbed:
            ...
            # Show IP ARP
            self.parsed_show_ip_arp = ParseShowCommandFunction.parse_show_command(steps, device, "show arp")

            # Show IP Interface Brief
            self.parsed_show_ip_int_brief = ParseShowCommandFunction.parse_show_command(steps, device, "show ip interface brief")

            # Show IP OSPF
            self.parsed_show_ip_ospf = ParseShowCommandFunction.parse_show_command(steps, device, "show ospf")

            # Show IP OSPF Dabase
            self.parsed_show_ip_ospf_database = ParseShowCommandFunction.parse_show_command(steps, device, "show ospf database")

            # Show IP OSPF Interface
            self.parsed_show_ip_ospf_interface = ParseShowCommandFunction.parse_show_command(steps, device, "show ospf interface")

            # Show IP OSPF Neighbor
            self.parsed_show_ip_ospf_neighbor = ParseShowCommandFunction.parse_show_command(steps, device, "show ospf neighbor")

            # Show IP OSPF Neighbor Detail
            self.parsed_show_ip_ospf_neighbor_detail = ParseShowCommandFunction.parse_show_command(steps, device, "show ospf neighbor detail")

            # Show IP Route
            self.parsed_show_ip_route = ParseShowCommandFunction.parse_show_command(steps, device, "show route")
            ...
            # Show VRF
            self.parsed_show_vrf = ParseShowCommandFunction.parse_show_command(steps, device, "show vrf all")
            # ---------------------------------------
            ...
            with steps.start('Store data',continue_=True) as step:
                ...
                if self.learned_acl is not None:
                    try:
                        ...
                        if os.path.exists("Camelot/Cisco/IOS_XR/Learned_ACL/%s_learned_acl.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Learned_ACL/%s_learned_acl.md --output Camelot/Cisco/IOS_XR/Learned_ACL/%s_learned_acl_mind_map.html" % (device.alias,device.alias))
                        ...
                        with open("Camelot/Cisco/IOS_XR/Learned_ACL/%s_learned_acl_netgraph.json" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_json)               
                            fh.close()

                        with open("Camelot/Cisco/IOS_XR/Learned_ACL/%s_learned_acl_netgraph.html" % device.alias, "w") as fh:
                ...
                if self.learned_arp is not None:
                    try:
                        ...
                        for filetype in filetype_loop:
                            ...
                            with open("Camelot/Cisco/IOS_XR/Learned_ARP/%s_learned_arp_statistics.%s" % (device.alias,filetype), "w") as fh:
                                fh.write(parsed_output_type) 
                                fh.close()

                        if os.path.exists("Camelot/Cisco/IOS_XR/Learned_ARP/%s_learned_arp.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Learned_ARP/%s_learned_arp.md --output Camelot/Cisco/IOS_XR/Learned_ARP/%s_learned_arp_mind_map.html" % (device.alias,device.alias))

                        if os.path.exists("Camelot/Cisco/IOS_XR/Learned_ARP/%s_learned_arp.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Learned_ARP/%s_learned_arp_statistics.md --output Camelot/Cisco/IOS_XR/Learned_ARP/%s_learned_arp_statistics_mind_map.html" % (device.alias,device.alias))
                        ...
                        with open("Camelot/Cisco/IOS_XR/Learned_ARP/%s_learned_arp_netgraph.json" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_json)               
                            fh.close()

                        with open("Camelot/Cisco/IOS_XR/Learned_ARP/%s_learned_arp_netgraph.html" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_html)
                            fh.close()
                        ...
                        with open("Camelot/Cisco/IOS_XR/Learned_ARP/%s_learned_arp_statistics_netgraph.json" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_json)
                            fh.close()

                        with open("Camelot/Cisco/IOS_XR/Learned_ARP/%s_learned_arp_statistics_netgraph.html" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_html)
                            fh.close()
                ...
                if self.learned_dot1x is not None:
                    try:
                        ...
                        if os.path.exists("Camelot/Cisco/IOS_XR/Learned_Dot1X/%s_learned_dot1x.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Learned_Dot1X/%s_learned_dot1x.md --output Camelot/Cisco/IOS_XR/Learned_Dot1X/%s_learned_dot1x_mind_map.html" % (device.alias,device.alias))
                        ...
                        with open("Camelot/Cisco/IOS_XR/Learned_Dot1X/%s_learned_dot1x_netgraph.json" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_json)
                            fh.close()             

                        with open("Camelot/Cisco/IOS_XR/Learned_Dot1X/%s_learned_dot1x_netgraph.html" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_html)
                            fh.close()
                        ...
                        for filetype in filetype_loop:
                            ...
                            with open("Camelot/Cisco/IOS_XR/Learned_Dot1X/%s_learned_dot1x_sessions.%s" % (device.alias,filetype), "w") as fh:
                                fh.write(parsed_output_type)
                                fh.close()
                        
                        if os.path.exists("Camelot/Cisco/IOS_XR/Learned_Dot1X/%s_learned_dot1x_sessions.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Learned_Dot1X/%s_learned_dot1x_sessions.md --output Camelot/Cisco/IOS_XR/Learned_Dot1X/%s_learned_dot1x_sessions_mind_map.html" % (device.alias,device.alias))
                        ...
                        with open("Camelot/Cisco/IOS_XR/Learned_Dot1X/%s_learned_dot1x_sessions_netgraph.json" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_json)
                            fh.close()

                        with open("Camelot/Cisco/IOS_XR/Learned_Dot1X/%s_learned_dot1x_sessions_netgraph.html" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_html)
                            fh.close()
                ...
                if self.learned_interface is not None:
                    try:
                        ...
                        for filetype in filetype_loop:
                            ...
                            with open("Camelot/Cisco/IOS_XR/Learned_Interface/%s_learned_interface.%s" % (device.alias,filetype), "w") as fh:
                                fh.write(parsed_output_type)
                                fh.close()
                        
                        if os.path.exists("Camelot/Cisco/IOS_XR/Learned_Interface/%s_learned_interface.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Learned_Interface/%s_learned_interface.md --output Camelot/Cisco/IOS_XR/Learned_Interface/%s_learned_interface_mind_map.html" % (device.alias,device.alias))
                        ...
                        with open("Camelot/Cisco/IOS_XR/Learned_Interface/%s_learned_interface_netgraph.json" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_json)
                            fh.close()               

                        with open("Camelot/Cisco/IOS_XR/Learned_Interface/%s_learned_interface_netgraph.html" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_html)
                            fh.close()
                        ...
                        with open("Camelot/Cisco/IOS_XR/Learned_Interface/%s_learned_interface_enabled_netgraph.json" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_json)
                            fh.close()               

                        with open("Camelot/Cisco/IOS_XR/Learned_Interface/%s_learned_interface_enabled_netgraph.html" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_html)
                            fh.close()
                ...
                if self.learned_lldp is not None:
                    try:
                        ...
                        if os.path.exists("Camelot/Cisco/IOS_XR/Learned_LLDP/%s_learned_lldp.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Learned_LLDP/%s_learned_lldp.md --output Camelot/Cisco/IOS_XR/Learned_LLDP/%s_learned_lldp_mind_map.html" % (device.alias,device.alias))
                        ...
                        with open("Camelot/Cisco/IOS_XR/Learned_LLDP/%s_learned_lldp_netgraph.json" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_json)
                            fh.close()               

                        with open("Camelot/Cisco/IOS_XR/Learned_LLDP/%s_learned_lldp_netgraph.html" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_html)
                            fh.close()
                        ...
                        for filetype in filetype_loop:
                            ...
                            with open("Camelot/Cisco/IOS_XR/Learned_LLDP/%s_learned_lldp_interfaces.%s" % (device.alias,filetype), "w") as fh:
                                fh.write(parsed_output_type)
                                fh.close() 
                        
                        if os.path.exists("Camelot/Cisco/IOS_XR/Learned_LLDP/%s_learned_lldp_interfaces.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Learned_LLDP/%s_learned_lldp_interfaces.md --output Camelot/Cisco/IOS_XR/Learned_LLDP/%s_learned_lldp_interfaces_mind_map.html" % (device.alias,device.alias))
                        ...
                        with open("Camelot/Cisco/IOS_XR/Learned_LLDP/%s_learned_lldp_interfaces_netgraph.json" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_json)
                            fh.close()               

                        with open("Camelot/Cisco/IOS_XR/Learned_LLDP/%s_learned_lldp_interfaces_netgraph.html" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_html)
                            fh.close()
                ...
                if self.learned_ntp is not None:
                    try:
                        ...
                        if os.path.exists("Camelot/Cisco/IOS_XR/Learned_NTP/%s_learned_ntp.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Learned_NTP/%s_learned_ntp.md --output Camelot/Cisco/IOS_XR/Learned_NTP/%s_learned_ntp_mind_map.html" % (device.alias,device.alias))
                        ...
                        with open("Camelot/Cisco/IOS_XR/Learned_NTP/%s_learned_ntp_netgraph.json" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_json)
                            fh.close()              

                        with open("Camelot/Cisco/IOS_XR/Learned_NTP/%s_learned_ntp_netgraph.html" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_html)
                            fh.close()
                        ...
                        for filetype in filetype_loop:
                            ...
                            with open("Camelot/Cisco/IOS_XR/Learned_NTP/%s_learned_ntp_associations.%s" % (device.alias,filetype), "w") as fh:
                                fh.write(parsed_output_type)
                                fh.close()
                        
                        if os.path.exists("Camelot/Cisco/IOS_XR/Learned_NTP/%s_learned_ntp_associations.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Learned_NTP/%s_learned_ntp_associations.md --output Camelot/Cisco/IOS_XR/Learned_NTP/%s_learned_ntp_associations_mind_map.html" % (device.alias,device.alias))
                        ...
                        with open("Camelot/Cisco/IOS_XR/Learned_NTP/%s_learned_ntp_associations_netgraph.json" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_json)
                            fh.close()

                        with open("Camelot/Cisco/IOS_XR/Learned_NTP/%s_learned_ntp_associations_netgraph.html" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_html)
                            fh.close()
                        ...
                        for filetype in filetype_loop:
                            ...
                            with open("Camelot/Cisco/IOS_XR/Learned_NTP/%s_learned_ntp_unicast.%s" % (device.alias,filetype), "w") as fh:
                                fh.write(parsed_output_type)
                                fh.close() 
                        
                        if os.path.exists("Camelot/Cisco/IOS_XR/Learned_NTP/%s_learned_ntp_unicast.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Learned_NTP/%s_learned_ntp_unicast.md --output Camelot/Cisco/IOS_XR/Learned_NTP/%s_learned_ntp_unicast_mind_map.html" % (device.alias,device.alias))
                        ...
                        with open("Camelot/Cisco/IOS_XR/Learned_NTP/%s_learned_ntp_unicast_netgraph.json" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_json)
                            fh.close()              

                        with open("Camelot/Cisco/IOS_XR/Learned_NTP/%s_learned_ntp_unicast_netgraph.html" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_html)
                            fh.close()
                ...
                if self.learned_ospf is not None:
                    try:
                        ...
                        if os.path.exists("Camelot/Cisco/IOS_XR/Learned_OSPF/%s_learned_ospf.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Learned_OSPF/%s_learned_ospf.md --output Camelot/Cisco/IOS_XR/Learned_OSPF/%s_learned_ospf_mind_map.html" % (device.alias,device.alias))
                        ...
                        with open("Camelot/Cisco/IOS_XR/Learned_OSPF/%s_learned_ospf_netgraph.json" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_json)
                            fh.close()              

                        with open("Camelot/Cisco/IOS_XR/Learned_OSPF/%s_learned_ospf_netgraph.html" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_html)
                            fh.close()
                ...
                if self.learned_routing is not None:
                    try:
                        ...
                        if os.path.exists("Camelot/Cisco/IOS_XR/Learned_Routing/%s_learned_routing.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Learned_Routing/%s_learned_routing.md --output Camelot/Cisco/IOS_XR/Learned_Routing/%s_learned_routing_mind_map.html" % (device.alias,device.alias))
                        ...
                        with open("Camelot/Cisco/IOS_XR/Learned_Routing/%s_learned_routing_netgraph.json" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_json)
                            fh.close()             

                        with open("Camelot/Cisco/IOS_XR/Learned_Routing/%s_learned_routing_netgraph.html" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_html)
                            fh.close()
                ...
                if self.learned_stp is not None:
                    try:
                        ...
                        if os.path.exists("Camelot/Cisco/IOS_XR/Learned_STP/%s_learned_stp.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Learned_STP/%s_learned_stp.md --output Camelot/Cisco/IOS_XR/Learned_STP/%s_learned_stp_mind_map.html" % (device.alias,device.alias))
                        ...
                        with open("Camelot/Cisco/IOS_XR/Learned_STP/%s_learned_stp_netgraph.json" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_json)
                            fh.close()               

                        with open("Camelot/Cisco/IOS_XR/Learned_STP/%s_learned_stp_netgraph.html" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_html)
                            fh.close()
                        ...
                        for filetype in filetype_loop:
                            ...
                            with open("Camelot/Cisco/IOS_XR/Learned_STP/%s_learned_stp_rpvst.%s" % (device.alias,filetype), "w") as fh:
                                fh.write(parsed_output_type)
                                fh.close() 
                        
                        if os.path.exists("Camelot/Cisco/IOS_XR/Learned_STP/%s_learned_stp_rpvst.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Learned_STP/%s_learned_stp_rpvst.md --output Camelot/Cisco/IOS_XR/Learned_STP/%s_learned_stp_rpvst_mind_map.html" % (device.alias,device.alias))
                        ...
                        with open("Camelot/Cisco/IOS_XR/Learned_STP/%s_learned_stp_rpvst_netgraph.json" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_json)
                            fh.close()               

                        with open("Camelot/Cisco/IOS_XR/Learned_STP/%s_learned_stp_rpvst_netgraph.html" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_html)
                            fh.close()
                ...
                if self.learned_vlan is not None:
                    ...
                    if os.path.exists("Camelot/Cisco/IOS_XR/Learned_VLAN/%s_learned_vlan.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Learned_VLAN/%s_learned_vlan.md --output Camelot/Cisco/IOS_XR/Learned_VLAN/%s_learned_vlan_mind_map.html" % (device.alias,device.alias))
                    ...
                    with open("Camelot/Cisco/IOS_XR/Learned_VLAN/%s_learned_vlan_netgraph.json" % device.alias, "w") as fh:
                        fh.write(parsed_output_netjson_json)
                        fh.close()               

                    with open("Camelot/Cisco/IOS_XR/Learned_VLAN/%s_learned_vlan_netgraph.html" % device.alias, "w") as fh:
                        fh.write(parsed_output_netjson_html)
                        fh.close()
                ...
                if self.learned_vrf is not None:
                    ...
                    for filetype in filetype_loop:
                        ...
                        with open("Camelot/Cisco/IOS_XR/Learned_VRF/%s_learned_vrf.%s" % (device.alias,filetype), "w") as fh:
                            fh.write(parsed_output_type) 
                    
                    if os.path.exists("Camelot/Cisco/IOS_XR/Learned_VRF/%s_learned_vrf.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Learned_VRF/%s_learned_vrf.md --output Camelot/Cisco/IOS_XR/Learned_VRF/%s_learned_vrf_mind_map.html" % (device.alias,device.alias))
                    ...
                    with open("Camelot/Cisco/IOS_XR/Learned_VRF/%s_learned_vrf_netgraph.json" % device.alias, "w") as fh:
                        fh.write(parsed_output_netjson_json)               

                    with open("Camelot/Cisco/IOS_XR/Learned_VRF/%s_learned_vrf_netgraph.html" % device.alias, "w") as fh:
                        fh.write(parsed_output_netjson_html)
                ...
                if self.parsed_show_access_lists is not None:
                    ...
                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_Access_Lists/%s_show_access_lists.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_Access_Lists/%s_show_access_lists.md --output Camelot/Cisco/IOS_XR/Show_Access_Lists/%s_show_access_lists_mind_map.html" % (device.alias,device.alias))
                    ...
                    with open("Camelot/Cisco/IOS_XR/Learned_VLAN/%s_show_access_lists_netgraph.json" % device.alias, "w") as fh:
                        fh.write(parsed_output_netjson_json)
                        fh.close()               

                    with open("Camelot/Cisco/IOS_XR/Learned_VLAN/%s_show_access_lists_netgraph.html" % device.alias, "w") as fh:
                        fh.write(parsed_output_netjson_html)
                        fh.close()
                ...
                if self.parsed_show_access_session is not None:
                    ...
                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_Access_Session_Interface_Details/%s_show_access_session_interface_details.json" % (device.alias)):
                       os.remove("Camelot/Cisco/IOS_XR/Show_Access_Session_Interface_Details/%s_show_access_session_interface_details.json" % (device.alias))

                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_Access_Session_Interface_Details/%s_show_access_session_interface_details.yaml" % (device.alias)):
                       os.remove("Camelot/Cisco/IOS_XR/Show_Access_Session_Interface_Details/%s_show_access_session_interface_details.yaml" % (device.alias))

                    for filetype in filetype_loop:
                        if os.path.exists("Camelot/Cisco/IOS_XR/Show_Access_Session_Interface_Details/%s_show_access_session_interface_details.%s" % (device.alias,filetype)):
                            os.remove("Camelot/Cisco/IOS_XR/Show_Access_Session_Interface_Details/%s_show_access_session_interface_details.%s" % (device.alias,filetype))

                    with open("Camelot/Cisco/IOS_XR/Show_Access_Session_Interface_Details/%s_show_access_session_interface_details.csv" % device.alias,'a') as csv:
                        csv.seek(0, 0)
                    ...
                    with open("Camelot/Cisco/IOS_XR/Show_Access_Session_Interface_Details/%s_show_access_session_interface_details.md" % device.alias,'a') as md:
                        md.seek(0, 0)
                    ...
                    with open("Camelot/Cisco/IOS_XR/Show_Access_Session_Interface_Details/%s_show_access_session_interface_details.html" % device.alias,'a') as html:
                        html.seek(0, 0)
                    ...
                    for filetype in filetype_loop:
                        ...
                        with open("Camelot/Cisco/IOS_XR/Show_Access_Sessions/%s_show_access_session_totals.%s" % (device.alias,filetype), "w") as fh:
                    ...
                    for interface in self.parsed_show_access_session['interfaces']:
                        ...
                        with steps.start('Store data',continue_=True) as step:       
                            with open("Camelot/Cisco/IOS_XR/Show_Access_Session_Interface_Details/%s_show_access_session_interface_details.json" % (device.alias), "a") as fid:
                                json.dump(self.parsed_show_ip_access_session_interface_details, fid, indent=4, sort_keys=True)
                                fid.write('\n')
                                
                            with open("Camelot/Cisco/IOS_XR/Show_Access_Session_Interface_Details/%s_show_access_session_interface_details.yaml" % (device.alias), "a") as yml:
                            ...
                            for filetype in filetype_loop:
                                ...
                                with open("Camelot/Cisco/IOS_XR/Show_Access_Session_Interface_Details/%s_show_access_session_interface_details.%s" % (device.alias,filetype), "a") as fh:
                                    fh.write(parsed_output_type)
                                    fh.close()
                    ...
                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_Access_Session_Interface_Details/%s_show_access_session_interface_details.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_Access_Session_Interface_Details/%s_show_access_session_interface_details.md --output Camelot/Cisco/IOS_XR/Show_Access_Session_Interface_Details/%s_show_access_session_interface_details_mind_map.html" % (device.alias,device.alias))

                    fid.close()
                    yml.close()

                if os.path.exists("Camelot/Cisco/IOS_XR/Show_Access_Sessions/%s_show_access_session.md" % device.alias):
                    os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_Access_Sessions/%s_show_access_session.md --output Camelot/Cisco/IOS_XR/Show_Access_Sessions/%s_show_access_session_mind_map.html" % (device.alias,device.alias))

                if os.path.exists("Camelot/Cisco/IOS_XR/Show_Access_Sessions/%s_show_access_session_totals.md" % device.alias):
                    os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_Access_Sessions/%s_show_access_session_totals.md --output Camelot/Cisco/IOS_XR/Show_Access_Sessions/%s_show_access_session_totals_mind_map.html" % (device.alias,device.alias))
                ...
                if self.parsed_show_authentication_sessions is not None:
                    ...
                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_Authentication_Session_Interface_Details/%s_show_authentication_session_interface_details.json" % (device.alias)):
                       os.remove("Camelot/Cisco/IOS_XR/Show_Authentication_Session_Interface_Details/%s_show_authentication_session_interface_details.json" % (device.alias))

                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_Authentication_Session_Interface_Details/%s_show_authentication_session_interface_details.yaml" % (device.alias)):
                       os.remove("Camelot/Cisco/IOS_XR/Show_Authentication_Session_Interface_Details/%s_show_authentication_session_interface_details.yaml" % (device.alias))

                    for filetype in filetype_loop:
                        if os.path.exists("Camelot/Cisco/IOS_XR/Show_Authentication_Session_Interface_Details/%s_show_authentication_session_interface_details.%s" % (device.alias,filetype)):
                            os.remove("Camelot/Cisco/IOS_XR/Show_Authentication_Session_Interface_Details/%s_show_authentication_session_interface_details.%s" % (device.alias,filetype))

                    with open("Camelot/Cisco/IOS_XR/Show_Authentication_Session_Interface_Details/%s_show_authentication_session_interface_details.csv" % device.alias,'a') as csv:
                        csv.seek(0, 0)
                        csv.write("Interface,User Name,Mac Address,Current Policy,Domain,IPv4 Address,IPv6 Address,VLAN,Method,State,Host Mode,Session Timeout Remaining,Status")
                        csv.close()                                   

                    with open("Camelot/Cisco/IOS_XR/Show_Authentication_Session_Interface_Details/%s_show_authentication_session_interface_details.md" % device.alias,'a') as md:
                        md.seek(0, 0)
                    ...
                    with open("Camelot/Cisco/IOS_XR/Show_Authentication_Session_Interface_Details/%s_show_authentication_session_interface_details.html" % device.alias,'a') as html:
                        html.seek(0, 0)
                    ...
                    for filetype in filetype_loop:
                        ...
                        with open("Camelot/Cisco/IOS_XR/Show_Authentication_Sessions/%s_show_authentication_session_totals.%s" % (device.alias,filetype), "w") as fh:
                            fh.write(parsed_output_totals_type)
                            fh.close()
                    ...
                    for interface in self.parsed_show_authentication_sessions['interfaces']:
                        ...
                        with steps.start('Store data',continue_=True) as step:       
                            with open("Camelot/Cisco/IOS_XR/Show_Authentication_Session_Interface_Details/%s_show_authentication_session_interface_details.json" % (device.alias), "a") as fid:
                                json.dump(self.parsed_show_authentication_session_interface_details, fid, indent=4, sort_keys=True)
                                fid.write('\n')
                                
                            with open("Camelot/Cisco/IOS_XR/Show_Authentication_Session_Interface_Details/%s_show_authentication_session_interface_details.yaml" % (device.alias), "a") as yml:
                            ...
                            for filetype in filetype_loop:
                                ...
                                with open("Camelot/Cisco/IOS_XR/Show_Authentication_Session_Interface_Details/%s_show_authentication_session_interface_details.%s" % (device.alias,filetype), "a") as fh:
                                    fh.write(parsed_output_type)
                    ...
                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_Authentication_Session_Interface_Details/%s_show_authentication_session_interface_details.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_Authentication_Session_Interface_Details/%s_show_authentication_session_interface_details.md --output Camelot/Cisco/IOS_XR/Show_Authentication_Session_Interface_Details/%s_show_authentication_session_interface_details_mind_map.html" % (device.alias,device.alias))
                    
                    fh.close()
                    fid.close()
                    yml.close()

                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_Authentication_Sessions/%s_show_authentication_sessions.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_Authentication_Sessions/%s_show_authentication_sessions.md --output Camelot/Cisco/IOS_XR/Show_Authentication_Sessions/%s_show_authentication_sessions_mind_map.html" % (device.alias,device.alias))

                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_Authentication_Sessions/%s_show_authentication_session_totals.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_Authentication_Sessions/%s_show_authentication_session_totals.md --output Camelot/Cisco/IOS_XR/Show_Authentication_Sessions/%s_show_authentication_session_totals_mind_map.html" % (device.alias,device.alias))
                ...
                if self.parsed_show_cdp_neighbors is not None:
                    ...
                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_CDP_Neighbors/%s_show_cdp_neighbors.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_CDP_Neighbors/%s_show_cdp_neighbors.md --output Camelot/Cisco/IOS_XR/Show_CDP_Neighbors/%s_show_cdp_neighbors_mind_map.html" % (device.alias,device.alias))
                    ...
                    with open("Camelot/Cisco/IOS_XR/Show_CDP_Neighbors/%s_show_cdp_neighbors_netgraph.json" % device.alias, "w") as fh:
                        fh.write(parsed_output_netjson_json)
                        fh.close()

                    with open("Camelot/Cisco/IOS_XR/Show_CDP_Neighbors/%s_show_cdp_neighbors_netgraph.html" % device.alias, "w") as fh:
                        fh.write(parsed_output_netjson_html)
                        fh.close()
                ...
                if self.parsed_show_cdp_neighbors_detail is not None:
                    ...
                    for filetype in filetype_loop:                    
                        ...
                        with open("Camelot/Cisco/IOS_XR/Show_CDP_Neighbors_Details/%s_show_cdp_neighbors_detail_totals.%s" % (device.alias,filetype), "w") as fh:
                          fh.write(parsed_totals)

                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_CDP_Neighbors_Details/%s_show_cdp_neighbors_detail.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_CDP_Neighbors_Details/%s_show_cdp_neighbors_detail.md --output Camelot/Cisco/IOS_XR/Show_CDP_Neighbors_Details/%s_show_cdp_neighbors_detail_mind_map.html" % (device.alias,device.alias))

                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_CDP_Neighbors/%s_show_cdp_neighbors_detail_totals.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_CDP_Neighbors_Details/%s_show_cdp_neighbors_detail_totals.md --output Camelot/Cisco/IOS_XR/Show_CDP_Neighbors_Details/%s_show_cdp_neighbors_detail_totals_mind_map.html" % (device.alias,device.alias))
                    ...
                    with open("Camelot/Cisco/IOS_XR/Show_CDP_Neighbors_Details/%s_show_cdp_neighbors_detail_netgraph.json" % device.alias, "w") as fh:
                        fh.write(parsed_output_netjson_json)
                        fh.close()               

                    with open("Camelot/Cisco/IOS_XR/Show_CDP_Neighbors_Details/%s_show_cdp_neighbors_detail_netgraph.html" % device.alias, "w") as fh:
                        fh.write(parsed_output_netjson_html)
                        fh.close()
                ...
                if self.parsed_show_environment is not None:
                    ...
                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_Environment/%s_show_environment.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_Environment/%s_show_environment.md --output Camelot/Cisco/IOS_XR/Show_Environment/%s_show_environment_mind_map.html" % (device.alias,device.alias))
                ...
                if self.parsed_show_etherchannel_summary is not None:
                    ...
                    for filetype in filetype_loop: 
                        ...
                        with open("Camelot/Cisco/IOS_XR/Show_Etherchannel_Summary/%s_show_etherchannel_summary_totals.%s" % (device.alias,filetype), "w") as fh:
                          fh.write(parsed_totals)
                          fh.close()

                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_Etherchannel_Summary/%s_show_etherchannel_summary.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_Etherchannel_Summary/%s_show_etherchannel_summary.md --output Camelot/Cisco/IOS_XR/Show_Etherchannel_Summary/%s_show_etherchannel_summary_mind_map.html" % (device.alias,device.alias))

                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_Etherchannel_Summary/%s_show_etherchannel_summary_totals.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_Etherchannel_Summary/%s_show_etherchannel_summary_totals.md --output Camelot/Cisco/IOS_XR/Show_Etherchannel_Summary/%s_show_etherchannel_summary_totals_mind_map.html" % (device.alias,device.alias))
                ...
                if self.parsed_show_int is not None:
                    try:
                        ...
                        if os.path.exists("Camelot/Cisco/IOS_XR/Show_Interfaces/%s_show_int.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_Interfaces/%s_show_int.md --output Camelot/Cisco/IOS_XR/Show_Interfaces/%s_show_int_mind_map.html" % (device.alias,device.alias))
                ...
                if self.parsed_show_int_status is not None:
                    try:
                        ...
                        if os.path.exists("Camelot/Cisco/IOS_XR/Show_Interfaces_Status/%s_show_int_status.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_Interfaces_Status/%s_show_int_status.md --output Camelot/Cisco/IOS_XR/Show_Interfaces_Status/%s_show_int_status_mind_map.html" % (device.alias,device.alias))
                ...
                if self.parsed_show_interfaces_trunk is not None:
                    try:
                        ...
                        if os.path.exists("Camelot/Cisco/IOS_XR/Show_Interfaces_Trunk/%s_show_interfaces_trunk.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_Interfaces_Trunk/%s_show_interfaces_trunk.md --output Camelot/Cisco/IOS_XR/Show_Interfaces_Trunk/%s_show_interfaces_trunk_mind_map.html" % (device.alias,device.alias))
                ...
                if self.parsed_show_inventory is not None:
                    ...
                    for filetype in filetype_loop:
                        ...
                        if device.platform == "cat4500":
                            ...
                            if os.path.exists("Camelot/Cisco/IOS_XR/Show_Inventory/%s_show_inventory.md" % device.alias):
                                os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_Inventory/%s_show_inventory.md --output Camelot/Cisco/IOS_XR/Show_Inventory/%s_show_inventory_mind_map.html" % (device.alias,device.alias))
                ...
                if self.parsed_show_ip_arp is not None:
                    ...
                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_IP_ARP/%s_show_ip_arp.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_IP_ARP/%s_show_ip_arp.md --output Camelot/Cisco/IOS_XR/Show_IP_ARP/%s_show_ip_arp_mind_map.html" % (device.alias,device.alias))
                ...
                if self.parsed_show_ip_int_brief is not None:
                    ...
                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_IP_Interface_Brief/%s_show_ip_int_brief.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_IP_Interface_Brief/%s_show_ip_int_brief.md --output Camelot/Cisco/IOS_XR/Show_IP_Interface_Brief/%s_show_ip_int_brief_mind_map.html" % (device.alias,device.alias))
                ...
                if self.parsed_show_ip_ospf is not None:
                    ...
                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_IP_OSPF/%s_show_ip_ospf.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_IP_OSPF/%s_show_ip_ospf.md --output Camelot/Cisco/IOS_XR/Show_IP_OSPF/%s_show_ip_ospf_mind_map.html" % (device.alias,device.alias))
                ...
                if self.parsed_show_ip_ospf_database is not None:
                    ...
                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_IP_OSPF_Database/%s_show_ip_ospf_database.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_IP_OSPF_Database/%s_show_ip_ospf_database.md --output Camelot/Cisco/IOS_XR/Show_IP_OSPF_Database/%s_show_ip_ospf_database_mind_map.html" % (device.alias,device.alias))
                ...
                if self.parsed_show_ip_ospf_interface is not None:
                    ...
                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_IP_OSPF_Interface/%s_show_ip_ospf_interface.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_IP_OSPF_Interface/%s_show_ip_ospf_interface.md --output Camelot/Cisco/IOS_XR/Show_IP_OSPF_Interface/%s_show_ip_ospf_interface_mind_map.html" % (device.alias,device.alias))
                ...
                if self.parsed_show_ip_ospf_neighbor is not None:
                    try:
                        ...
                        if os.path.exists("Camelot/Cisco/IOS_XR/Show_IP_OSPF_Neighbor/%s_show_ip_ospf_neighbor.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_IP_OSPF_Neighbor/%s_show_ip_ospf_neighbor.md --output Camelot/Cisco/IOS_XR/Show_IP_OSPF_Neighbor/%s_show_ip_ospf_neighbor_mind_map.html" % (device.alias,device.alias))
                ...
                if self.parsed_show_ip_ospf_neighbor_detail is not None:
                    try:
                        ...
                        if os.path.exists("Camelot/Cisco/IOS_XR/Show_IP_OSPF_Neighbor_Detail/%s_show_ip_ospf_neighbor_detail.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_IP_OSPF_Neighbor_Detail/%s_show_ip_ospf_neighbor_detail.md --output Camelot/Cisco/IOS_XR/Show_IP_OSPF_Neighbor_Detail/%s_show_ip_ospf_neighbor_detail_mind_map.html" % (device.alias,device.alias))
                ...
                if self.parsed_show_ip_route is not None:
                    try:
                        ...
                        if os.path.exists("Camelot/Cisco/IOS_XR/Show_IP_Route/%s_show_ip_route.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_IP_Route/%s_show_ip_route.md --output Camelot/Cisco/IOS_XR/Show_IP_Route/%s_show_ip_route_mind_map.html" % (device.alias,device.alias))
                        ...
                        with open("Camelot/Cisco/IOS_XR/Show_IP_Route/%s_show_ip_route_netgraph.json" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_json)
                            fh.close()              

                        with open("Camelot/Cisco/IOS_XR/Show_IP_Route/%s_show_ip_route_netgraph.html" % device.alias, "w") as fh:
                            fh.write(parsed_output_netjson_html)
                            fh.close()
                ...
                if device.platform == "cat4500":
                    if self.parsed_show_issu_state is not None:
                        ...
                        if os.path.exists("Camelot/Cisco/IOS_XR/Show_ISSU_State/%s_show_issu_state.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_ISSU_State/%s_show_issu_state.md --output Camelot/Cisco/IOS_XR/Show_ISSU_State/%s_show_issu_state_mind_map.html" % (device.alias,device.alias))
                ...
                if self.parsed_show_mac_address_table is not None:
                    ...
                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_MAC_Address_Table/%s_show_mac_address_table.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_MAC_Address_Table/%s_show_mac_address_table.md --output Camelot/Cisco/IOS_XR/Show_MAC_Address_Table/%s_show_mac_address_table_mind_map.html" % (device.alias,device.alias))
                ...
                if self.parsed_show_ntp_associations is not None:
                    ...
                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_NTP_Associations/%s_show_ntp_associations.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_NTP_Associations/%s_show_ntp_associations.md --output Camelot/Cisco/IOS_XR/Show_NTP_Associations/%s_show_ntp_associations_mind_map.html" % (device.alias,device.alias))
                ...
                if self.parsed_show_power_inline is not None:
                    ...
                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_Power_Inline/%s_show_power_inline.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_Power_Inline/%s_show_power_inline.md --output Camelot/Cisco/IOS_XR/Show_Power_Inline/%s_show_power_inline_mind_map.html" % (device.alias,device.alias))
                    ...
                    for filetype in filetype_loop:  
                        ...
                        with open("Camelot/Cisco/IOS_XR/Show_Power_Inline/%s_show_power_inline_totals.%s" % (device.alias,filetype), "w") as fh:
                          fh.write(parsed_output_type)                                                                     

                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_Power_Inline/%s_show_power_inline_totals.md" % device.alias):
                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_Power_Inline/%s_show_power_inline_totals.md --output Camelot/Cisco/IOS_XR/Show_Power_Inline/%s_show_power_inline_totals_mind_map.html" % (device.alias,device.alias))
                ...
                if self.parsed_show_version is not None:
                    try:
                        ...
                        if os.path.exists("Camelot/Cisco/IOS_XR/Show_Version/%s_show_version.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_Version/%s_show_version.md --output Camelot/Cisco/IOS_XR/Show_Version/%s_show_version_mind_map.html" % (device.alias,device.alias))
                ...
                if self.parsed_show_vlan is not None:
                    try:
                        ...
                        if os.path.exists("Camelot/Cisco/IOS_XR/Show_VLAN/%s_show_vlan.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_VLAN/%s_show_vlan.md --output Camelot/Cisco/IOS_XR/Show_VLAN/%s_show_vlan_mind_map.html" % (device.alias,device.alias))
                ...
                if self.parsed_show_vrf is not None:
                    try:
                        ...
                        if os.path.exists("Camelot/Cisco/IOS_XR/Show_VRF/%s_show_vrf.md" % device.alias):
                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_VRF/%s_show_vrf.md --output Camelot/Cisco/IOS_XR/Show_VRF/%s_show_vrf_mind_map.html" % (device.alias,device.alias))
                        ...
                        for vrf in self.parsed_show_vrf['vrf']:
                            ...
                            if hasattr(Collect_Information, 'self.parsed_show_ip_arp_vrf'):
                                with steps.start('Store data',continue_=True) as step:
                                    ...
                                    with open("Camelot/Cisco/IOS_XR/Show_IP_ARP_VRF/%s_show_ip_arp_vrf_%s.json" % (device.alias,vrf), "w") as fid:
                                        json.dump(self.parsed_show_ip_arp_vrf, fid, indent=4, sort_keys=True)
                                        fid.close()

                                    with open("Camelot/Cisco/IOS_XR/Show_IP_ARP_VRF/%s_show_ip_arp_vrf_%s.yaml" % (device.alias,vrf), "w") as yml:
                                    ...
                                    for filetype in filetype_loop:
                                        ...
                                        with open("Camelot/Cisco/IOS_XR/Show_IP_ARP_VRF/%s_show_ip_arp_vrf_%s.%s" % (device.alias,vrf,filetype), "w") as fh:
                                            fh.write(parsed_output_type)
                                            fh.close()

                                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_IP_ARP_VRF/%s_show_ip_arp_vrf_%s.md" % (device.alias,vrf)):
                                        os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_IP_ARP_VRF/%s_show_ip_arp_vrf_%s.md --output Camelot/Cisco/IOS_XR/Show_IP_ARP_VRF/%s_show_ip_arp_vrf_%s_mind_map.html" % (device.alias,vrf,device.alias,vrf))
                            ...
                            if hasattr(Collect_Information, 'self.parsed_show_ip_route_vrf'):
                                with steps.start('Store data',continue_=True) as step:
                                    ...
                                    with open("Camelot/Cisco/IOS_XR/Show_IP_Route_VRF/%s_show_ip_route_vrf_%s.json" % (device.alias,vrf), "w") as fid:
                                        json.dump(self.parsed_show_ip_route_vrf, fid, indent=4, sort_keys=True)
                                        fid.close()

                                    with open("Camelot/Cisco/IOS_XR/Show_IP_Route_VRF/%s_show_ip_route_vrf_%s.yaml" % (device.alias,vrf), "w") as yml:
                                    ...
                                    for filetype in filetype_loop:
                                        ...
                                        with open("Camelot/Cisco/IOS_XR/Show_IP_Route_VRF/%s_show_ip_route_vrf_%s.%s" % (device.alias,vrf,filetype), "w") as fh:
                                            fh.write(parsed_output_type)
                                            fh.close()

                                    if os.path.exists("Camelot/Cisco/IOS_XR/Show_IP_Route_VRF/%s_show_ip_route_vrf_%s.md" % (device.alias,vrf)):
                                            os.system("markmap --no-open Camelot/Cisco/IOS_XR/Show_IP_Route_VRF/%s_show_ip_route_vrf_%s.md --output Camelot/Cisco/IOS_XR/Show_IP_Route_VRF/%s_show_ip_route_vrf_%s_mind_map.html" % (device.alias,vrf,device.alias,vrf))
...
# ----------------
    def save_to_json_file(self, device, directory, file_name, content):
        file_path = "Camelot/Cisco/IOS_XR/{}/{}_{}.json".format(directory, device.alias, file_name)
        with open(file_path, "w") as json_file:
            json.dump(content, json_file, indent=4, sort_keys=True)
            json_file.close()
    
    def save_to_yaml_file(self, device, directory, file_name, content):
        file_path = "Camelot/Cisco/IOS_XR/{}/{}_{}.yaml".format(directory, device.alias, file_name)
    ...
    def save_to_specified_file_type(self, device, directory, file_name, content, file_type):
        file_path = "Camelot/Cisco/IOS_XR/{}/{}_{}.{}".format(directory, device.alias, file_name, file_type)
